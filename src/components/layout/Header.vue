    ...
    <div class="px-6 py-4 flex items-center justify-between">
      <div class="flex items-center gap-4">
        ...
        <button
          ...
          class="p-2 hover:bg-gray-100 rounded-lg transition-all duration-200 md:hidden"
        >
        ...
        <div class="flex items-center gap-3">
          <div class="flex items-center gap-2">
            ...
            <span class="font-semibold text-lg text-gray-900">OSS Knowledge</span>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="relative">
          <button
            ...
            class="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg transition-all duration-200"
          >
          ...
          >
            ...
            >
              ...
              <button class="w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-200 flex items-center gap-2">
