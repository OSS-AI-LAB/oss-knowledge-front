<template>
  ...
  >
    <div
      v-if="show"
      class="fixed bottom-4 right-4 max-w-md rounded-lg p-4 shadow-lg"
    ...
    >
      <div class="flex items-start">
        ...
        <div class="ml-3">
          <p class="text-sm" :class="textClasses">{{ message }}</p>
        </div>
...
const closeButtonClasses = computed(() => {
  return props.type === 'error' ? 'text-red-400' : 'text-green-400'
})
</script> 