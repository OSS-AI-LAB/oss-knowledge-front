    ...
    >
        ...
        >
            <div class="text-center max-w-2xl mx-auto px-6 pb-32">
                <div class="mb-8">
                    <div
                        class="w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center"
                    >
                        <svg
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
                    <button
                        ...
                        class="p-4 text-left bg-white border border-gray-200 rounded-2xl hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 group shadow-sm hover:shadow-md"
                    >
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="flex gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            ></div>
                            <span
                                class="inline-block w-3 h-5 bg-blue-500 animate-pulse ml-1 rounded-sm"
                            ></span>
                        </div>
                    </div>
                </div>
